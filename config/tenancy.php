...
return [
    'tenant_model' => TenantCompany::class,
    'id_generator' => null,
     ...
     */
    'cache' => [
        'tag_base' => 'cache_tenant_no_', // This tag_base, followed by the tenant_id, will form a tag that will be applied on each cache call.
    ],
    ...
    'filesystem' => [
         ...
         */
        'suffix_base' => 'tenants/tenant_no_',
        'disks' => [
            'local',
            'public',
            'front_separated'
